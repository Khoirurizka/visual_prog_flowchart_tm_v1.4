...
const url_gripper_frame ="http://localhost:5001/bev_frame_feed"

function BEV_FrameRender() {
    ...
    >
      {videoAvailable ? (
        ...
        <div style={{ padding: '20px' }}>
          <p>BEV Capture is not unavailable, please update manually with refresh button.</p>
        </div>
      )}
...
export default BEV_FrameRender;
